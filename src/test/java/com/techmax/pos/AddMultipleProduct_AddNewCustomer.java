...
public class AddMultipleProduct_AddNewCustomer {
	...
	public static void main(String[] args) throws IOException {
		...
		String FN=book.getSheet("Sheet1").getRow(4).getCell(1).getStringCellValue();
		String LN=book.getSheet("Sheet1").getRow(5).getCell(1).getStringCellValue();
		DataFormatter format=new DataFormatter();
		String PN=format.formatCellValue((book.getSheet("Sheet1").getRow(6).getCell(1)));
		...
		driver.findElement(By.xpath("(//input[@placeholder='First Name'])[2]")).sendKeys(FN);
		driver.findElement(By.xpath("(//input[@placeholder='Last Name'])[2]")).sendKeys(LN);
		driver.findElement(By.xpath("(//input[@placeholder='Phone Number'])[2]")).sendKeys(PN);
